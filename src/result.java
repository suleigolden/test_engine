 ...
 Connection conn;
  ...
  private void setIcon() {
    ...
    public void get_candidate_result(){
        ...
        String value1 = st.getCadidate_result_id();
        String candidate_name = nt.getCadidate_test_name();
        try{
     
             String sql ="select * from test_result where Reg_no ='"+value1+"' AND Name='"+candidate_name+"' ";
             ...
             if(rs.next()){
                    ...
                    int t1 = Integer.parseInt(add6);
                    int t2 = t1 - 1;
                    lb_total_question.setText(String.format("%s", t2));
             }
        }catch(Exception e){
        ...
        try{
             ...
             if(rs.next()){
                    ...
                    String add4 =rs.getString("passing");
                      ...
                      int i=Integer.parseInt(add4);
                      int i2 = i * 2;
                      jProgressBar3.setValue(i2);
